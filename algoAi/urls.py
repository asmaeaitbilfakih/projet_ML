...
urlpatterns = [
    ...
    path('regLog_details', views.regLog_details, name='regLog_details'),
    path('vehicles_form',views.vehicles_form,name='vehicles_form'),
    path('reglog_results',views.reglog_results,name='reglog_results'),
    ...
    path('reglog/predict/', views.housing_prediction, name='housing_prediction'), 
